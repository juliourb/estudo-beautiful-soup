...
class ImovelWebAdapter(BaseAdapter):
    site_name = "imovelweb"
    base_url = "https://www.imovelweb.com.br/imoveis-aluguel-sao-paulo-sp.html"

    def extract(self, html: str) -> list[Listing]:
        soup = BeautifulSoup(html, "lxml")
        cards = soup.select("div.postingCard, article, div[data-qa='posting-card']")
